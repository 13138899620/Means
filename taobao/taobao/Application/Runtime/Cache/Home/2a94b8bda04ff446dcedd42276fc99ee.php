    ...
    <div class="header_top">
        <div class="container">
            ...
            <ul class="shopping_grid">
                <a href="#"><li>爱淘宝</li></a>
                <a href="login.html"><li>聚划算</li></a>
                <a href="#"><li><span class="m_1">淘宝特卖</span>&nbsp;<img src="http://www.yangyi.com:81/Public/images/bag.png" alt=""/></li></a>
            ...
            <div class="col-md-3 sidebar_box">
                <div class="sidebar">
                    <div class="menu_box">
                        ...
                        <ul class="menu">
                            <li class="item1"><a href="#"><img class="arrow-img" src="http://www.yangyi.com:81/Public/images/f_menu.png" alt=""/> Man</a>
                                <ul class="cute">
                            ...
                            <li class="item2"><a href="#"><img class="arrow-img" src="http://www.yangyi.com:81/Public/images/f_menu.png" alt=""/>Women</a>
                                <ul class="cute">
                                    <li class="subitem1"><a href="#">Cute Kittens </a></li>
                                    <li class="subitem2"><a href="#">Strange Stuff </a></li>
                                    <li class="subitem3"><a href="#">Automatic Fails </a></li>
                            ...
                            <li class="item3"><a href="#"><img class="arrow-img" src="http://www.yangyi.com:81/Public/images/f_menu.png" alt=""/>Fashion 2015</a>
                                <ul class="cute">
                                    <li class="subitem1"><a href="#">Cute Kittens </a></li>
                                    <li class="subitem2"><a href="#">Strange Stuff </a></li>
                                    <li class="subitem3"><a href="#">Automatic Fails</a></li>
                            ...
                            <li class="item4"><a href="#"><img class="arrow-img" src="http://www.yangyi.com:81/Public/images/f_menu.png" alt=""/>Kids</a>
                                <ul class="cute">
                                    <li class="subitem1"><a href="#">Cute Kittens </a></li>
                                    <li class="subitem2"><a href="#">Strange Stuff </a></li>
                                    <li class="subitem3"><a href="#">Automatic Fails </a></li>
                            ...
                            <li class="item5"><a href="#"><img class="arrow-img" src="http://www.yangyi.com:81/Public/images/f_menu.png" alt=""/>Jeans</a>
                                <ul class="cute">
                                    <li class="subitem1"><a href="#">Cute Kittens </a></li>
                                    <li class="subitem2"><a href="#">Strange Stuff </a></li>
                                    <li class="subitem3"><a href="#">Automatic Fails </a></li>
                            ...
                            <li class="item6"><a href="#"><img class="arrow-img" src="http://www.yangyi.com:81/Public/images/f_menu.png" alt=""/>Tshirt</a>
                                <ul class="cute">
                                    <li class="subitem1"><a href="#">Cute Kittens </a></li>
                                    <li class="subitem2"><a href="#">Strange Stuff </a></li>
                                    <li class="subitem3"><a href="#">Automatic Fails </a></li>
                            ...
                            <li class="item7"><a href="#"><img class="arrow-img" src="http://www.yangyi.com:81/Public/images/f_menu.png" alt=""/>Top Fashion</a>
                                <ul class="cute">
                                    <li class="subitem1"><a href="#">Cute Kittens </a></li>
                                    <li class="subitem2"><a href="#">Strange Stuff </a></li>
                                    <li class="subitem3"><a href="#">Automatic Fails </a></li>
                            ...
                            <li class="item8"><a href="#"><img class="arrow-img" src="http://www.yangyi.com:81/Public/images/f_menu.png" alt=""/>Summer Collection</a>
                                <ul class="cute">
                                    <li class="subitem1"><a href="#">Cute Kittens </a></li>
                                    <li class="subitem2"><a href="#">Strange Stuff </a></li>
                                    <li class="subitem3"><a href="#">Automatic Fails </a></li>
                            ...
                            <li class="item9"><a href="#"><img class="arrow-img" src="http://www.yangyi.com:81/Public/images/f_menu.png" alt=""/>Special Offer</a>
                                <ul class="cute">
                                    <li class="subitem1"><a href="#">Cute Kittens </a></li>
                                    <li class="subitem2"><a href="#">Strange Stuff </a></li>
                                    <li class="subitem3"><a href="#">Automatic Fails </a></li>
