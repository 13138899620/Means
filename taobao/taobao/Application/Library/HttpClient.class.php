 ...
 * WebAPI Client
 */
class HttpClient implements \Iterator, \ArrayAccess {
    public $options;
    ...
    public function offsetSet($key, $value){
        throw new HttpClientException("Decoded response data is immutable.");
    }
    ...
    public function get($url, $parameters=array(), $headers=array()){
        return $this->execute($url, 'GET', $parameters, null, $headers);
    }

    public function post($url, $parameters=array(), $data="", $headers=array()){
        return $this->execute($url, 'POST', $parameters, $data, $headers);
    }

    public function execute($url, $method='GET', $parameters=array(), $data=null, $headers=array()){
        $client = clone $this;
        $client->url = $url;
    ...
    public function decode_response(){
        if(empty($this->decoded_response)){
            ...
            if(!array_key_exists($format, $this->options['decoders']))
                throw new HttpClientException("'${format}' is not a supported ".
